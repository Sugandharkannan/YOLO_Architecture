import os
import sys
# Add parent directory to path so python can resolve backend package imports
...
if __name__ == "__main__":
    ...
    # Disable reload in production if needed, but keeping reload=True for dev simplicity or checking environment
